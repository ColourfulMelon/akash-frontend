...
export default function Footer({ className }: { className?: string }) {
    return (
        <section className={cn("flex flex-col align-middle text-white w-full p-4 text-center absolute bottom-2", className)}>

            {/*<div className='flex justify-center mb-4'>*/}
            {/*    <Image src='/images/akash-powered.svg' alt="akash" width={134} height={52}/>*/}
            {/*</div>*/}

            <div className="flex mx-auto gap-2 text-sm sm:text-base h-5">
                <div className="flex">
                    <Github/>
                ...
                <Separator orientation="vertical" className='bg-primary-foreground h-full'/>
                <p>
